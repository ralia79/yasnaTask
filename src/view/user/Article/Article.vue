<template>
    ...
    <div class="container cover w-100 d-flex flex-column align-items-center justify-content-center">
...
.abstractOnject::after {
    content: url('../../../assets/Vector3.png');
    position: absolute;
    left: 50px;
    top: -50px;
}

.abstractOnject::before {
    content: url('../../../assets/Vector3.png');
    position: absolute;
    right: 50px;
    bottom: 10px;
